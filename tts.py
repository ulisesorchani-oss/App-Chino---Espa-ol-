...
#    - Chino:  4 voces (v9.4): femenina (Xiaoxiao), masculina
#      (Yunjian), femenina joven (Xiaoyi) y masculina joven (Yunxi)
...
# v9.4: el cliente puede pedir f/m/f2/m2 para chino (el botón 🇨🇳 cicla
# las cuatro); el español mantiene f/m.
EDGE_VOICES = {
    ("zh-CN", "f"): "zh-CN-XiaoxiaoNeural",   # 🇨🇳 femenina, cálida y clara
    ("zh-CN", "m"): "zh-CN-YunjianNeural",    # 🇨🇳 masculina, madura
    ("zh-CN", "f2"): "zh-CN-XiaoyiNeural",    # 🇨🇳 femenina 2, joven y animada
    ("zh-CN", "m2"): "zh-CN-YunxiNeural",     # 🇨🇳 masculina 2, joven
